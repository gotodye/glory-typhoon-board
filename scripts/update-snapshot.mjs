...
【已知線報，請納入研判但務必標明未證實】沖繩當地包車業者通報：原定 7/10 13:30～7/11 13:00 靠泊那霸的本航次（基隆–那霸–基隆）MSC BELLISSIMA，已傳「不會入港沖繩那霸」，業者正協助旅客退訂當地行程。請在 summary 與 prediction 中把「那霸靠港恐取消」納入考量，但要明確標示這是「當地業者通報、尚未經 MSC 或旅行社官方證實」；這條線報「不算官方公告」，official 欄位不可因此設為 true。若你搜尋到更新的官方公告或反證，一律以最新查證結果為準。
